	  ...
	  client.on('message', message => {
		if (message.content === '-iloto') {   
		  message.delete()
			...
			.addField("**3.**", "Il est possible que le même pseudo soit tiré au sort à plusieurs reprises. Le joueur peu gagné que le premier lot sur le quelle il est tombé ")
